...
makeCacheMatrix <- function(x = matrix()) {
  ...
  }                         ##(Note: will now resolve matrix even if matrix is identical to previous use)
...
## Finds the inverse of the given "matrix", however only solves it if the solution is not stored in the cache
